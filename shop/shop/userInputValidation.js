...
function validateForm() {
    ...
    if(addressInput.value.trim()==''){
     ...
     if(ZipcodeInput.value.trim()==''){
        setError(ZipcodeInput, 'Zipcode can not be empty');
    }else if(ZipcodeInput.value.trim().length <6 || ZipcodeInput.value.trim().length >10){
        setError(ZipcodeInput, 'Zipcode min 4 max 10 charecters');
    }else {
